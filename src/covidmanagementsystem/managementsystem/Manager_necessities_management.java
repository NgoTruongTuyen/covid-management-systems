...
public class Manager_necessities_management extends javax.swing.JFrame {
    ...
    public Manager_necessities_management() {
        ...
        loadComboUnit();
        viewNecessities();
        managerModify = new ManagerModify();
    }
    ...
    private void jbUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbUpdateActionPerformed
        ...
        if (id.length() == 0 || name.length() == 0 || limit.length() == 0 || price.length() == 0 || limitDate.length() == 0) {
            ...
            if (NecessitiesModify.updateNecessities(oldId, id, name, Integer.valueOf(limit), limitDate, Integer.valueOf(price)) == true) {
                ...
                String content = currentDateTime + ": update necessity - " + name;
    ...
    private void jbAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAddActionPerformed
        ...
        if (id.length() == 0 || name.length() == 0 || limit.length() == 0 || price.length() == 0 || limitDate.length() == 0) {
            ...
            if (NecessitiesModify.addNecessities(id, name, Integer.valueOf(limit), limitDate, Integer.valueOf(price)) == true) {
                ...
                LocalDateTime localDateTime = LocalDateTime.now();
                String currentDateTime = managerModify.formatDateTime(localDateTime);
                String content = currentDateTime + ": add new necessity - " + name;
                managerModify.saveHistory(managerId, content);
    ...
    private void jbDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbDeleteActionPerformed
        ...
        if (id.length() == 0) {
            ...
            if (NecessitiesModify.deleteNecessities(id) == true) {
                ...
                LocalDateTime localDateTime = LocalDateTime.now();
                String currentDateTime = managerModify.formatDateTime(localDateTime);
                String content = currentDateTime + ": delete necessity - " + jtfName.getText();
                managerModify.saveHistory(managerId, content);
