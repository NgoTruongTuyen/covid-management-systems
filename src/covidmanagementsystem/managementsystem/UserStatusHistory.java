...
public class UserStatusHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jbInformation, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 550, 270, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserStatusHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
